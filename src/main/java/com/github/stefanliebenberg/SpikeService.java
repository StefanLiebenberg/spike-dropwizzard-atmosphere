...
public class SpikeService extends Service<SpikeConfiguration> {
    ...
    public void initializeAtmosphere(SpikeConfiguration configuration,
        ...
        FilterBuilder fconfig = environment.addFilter(
                CrossOriginFilter.class, "/spike");
        ...
        framework
                .addInitParameter(
                        ...
                        "com.github.stefanliebenberg.atmosphere")
                .addInitParameter(
                        "org.atmosphere.websocket.messageContentType",
                        "application/json");
        // framework.addInitParameter("org.atmosphere.cpr
        // .broadcastFilterClasses", "com.example.helloworld.filters
        // .BadWordFilter");
        environment.addServlet(atmosphereServlet, "/spike/*");
    }
